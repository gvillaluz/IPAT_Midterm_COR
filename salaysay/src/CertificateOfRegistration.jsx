                ...
                return (
                  <tr key={index}>
                    ...
                    >
                      <input
                        type="text"
                        value={subject.subject_code || "Null"}
                        style={{
                          color: "black",
                          width: "98%",
                          border: "none",
                    ...
                    >
                      <input
                        type="text"
                        value={subject.subject_title || "Null"}
                        style={{
                          color: "black",
                          width: "98%",
                          textAlign: "center",
                    ...
                    >
                      <input
                        type="text"
                        value={subject.subject_section || "Null"}
                        style={{
                          color: "black",
                          width: "98%",
                          textAlign: "center",
                    ...
                    >
                      <input
                        type="text"
                        value={subject.subject_schedule_room || "Null"}
                        style={{
                          color: "black",
                          width: "98%",
                          textAlign: "center",
